<main class="main-content">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="ps-lg-10 pe-lg-10 ms-lg-2 me-lg-2 mb-10 mb-lg-0 text-center text-lg-start">
                        <img src="assets/images/photos/d1.jpg" alt="Image-HasTech" width="449" height="550">
                    </div>
                </div>
                <div class="col-lg-6 text-center text-lg-start">
                    <h2 class="divider-title mt-n2">Elehaus Story, We Craft Awesome With Great Experiences.</h2>
                    <p class="divider-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmo
                        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minimo veniam, quis nostrud
                        exercitation ullamco laboris nisi ut aliquip ex eatrl commodo consequat. Duis aute irure dolor
                        in reprehenderit in voluptat velit esse cillum dolore eu fugiat nulla pariatur.</p>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide testimonial-item">
                            <div class="testimonial-content">
                                <p>Lorem ipsum dolor sit amet, consl adipi elit, sed do eiusmod tempor incididu ut
                                    labore et dolore magn aliqua Ut enim admin.</p>
    ...
    <div class="gallery-area section-space">
        <div class="container">
            <div class="section-title text-center">
                <h2 class="title mb-n1 mt-n2">Follow <span class="text-primary">@Elehaus</span> on Instagram</h2>
            </div>
            <div class="row row-cols-3 row-cols-sm-3 row-cols-lg-5 gx-4 mb-n6 justify-content-center">
                <div class="col mb-6">
                    <div class="gallery-item">
                        ...
                        <a class="gallery-overlay" target="_blank" rel="noopener" href="https://www.instagram.com/">
